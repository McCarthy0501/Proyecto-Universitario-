...
import Lightbox from '../../components/complementos/Lightbox';
...
function ProductDetailPage() {
 ...
 {colors.length > 0 && (
 <div className="mb-4">
 <label className="block text-sm font-medium text-gray-700 mb-2">Color: {selectedColor?.variation_value || ''}</label>
 ...
 rosa: '#ec4899', marron: '#78350f', beige: '#d6c8a0',
 cafe: '#78350f', dorado: '#d4a843', plateado: '#c0c0c0',
 celeste: '#38bdf8', turquesa: '#14b8a6', violeta: '#8b5cf6',
 coral: '#fb7185', vino: '#9f1239', mostaza: '#ca8a04',
 azul_marino: '#1e3a5f', verde_militar: '#4d7c0f', crema: '#fef3c7',
 };
 const colorName = color.variation_value.toLowerCase().trim();
 const bgColor = colorMap[colorName] || colorMap[colorName.replace(/\s+/g, '_')] || '#d1d5db';
 const isSelected = selectedColor?.id === color.id;
 const isWhite = bgColor === '#f9fafb' || colorName === 'blanco';
 return (
 <button
 key={color.id}
 ...
 <div key={prod.id} className="min-w-[280px] max-w-[280px]">
