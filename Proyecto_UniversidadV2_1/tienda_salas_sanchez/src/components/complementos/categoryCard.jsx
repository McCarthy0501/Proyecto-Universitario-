...
function CategoryCard({category,onCategoryClick}) {
 ...
 <div className="absolute bottom-3 right-3 bg-white p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">
